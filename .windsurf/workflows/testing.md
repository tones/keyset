...
- `e2e/song.spec.ts` — Song page tests (rename, reorder key sets, add/delete key sets, chord identification labels, color palette, LLM analysis display/delete, navigation)
