...
export async function saveKeySets(songId: number, keySets: { type: string; scaleDegree?: number | null; keyPresses: { midiNote: number; color: string }[] }[], analysis?: { text: string | null; updatedAt: string | null }, songKey?: string | null) {
